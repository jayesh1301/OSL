...
function ViewInwardRegister() {
  ...
  const columns = [
    ...
    { field: 'time', headerName: 'Time', flex: 1, headerClassName: classes.blueHeader },
  ...
  const rows = [
    { id: 1, sn: 1, dcNo: '299826', date: '9-03-2024', time: '15:36:43', vehicleNo: 'MH.14.LB.7268', from: 'HOSUR', to: 'PUNE' },
    { id: 2, sn: 2, dcNo: '300178', date: '9-03-2024', time: '14:59:23', vehicleNo: 'NL.01.AE.7379', from: 'HOSUR', to: 'PUNE' },
  ];
