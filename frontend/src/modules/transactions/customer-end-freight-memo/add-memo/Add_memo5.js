...
import Add_memo7 from './Add_memo7';
import Add_memo8 from './Add_memo8';
...
function Add_memo5() {
  ...
  const columns = [
    ...
    { field: 'InvAmt', headerName: 'Inv amt', flex:1 ,headerClassName: classes.blueHeader},
  ...
  return (
    <>
        ...
        <Grid item xs={6} md={2} ml={16} sx={{ float: 'center' }}>
          <Typography
            sx={{ fontFamily: 'poppins', fontSize: '1.60rem', marginBottom: 2 , display:'flex'}}
          >
Customer End Hire Memo
