  ...
  const fetchAllData = async () => {
    ...
    try {
      ...
      const formattedData = Report.map((item) => {
        return {
          "Sr No": item.srNo ?? "",
          "Memo No": item.memo_no ?? "",
          "Memo Date": item.memo_date ?? "",
          "DC No": item.dc_no ?? "",
          "DC Date": item.dc_date ?? "",
          "Memo From": item.from_loc ?? "",
          "Memo To": item.to_loc ?? "",
          "Memo Status": item.memo_status ?? "",
          "OSL Bill No": item.billno ?? "",
          "OSL Bill Date": item.billdate ?? "",
          "Transporter Bill No": item.trbillno ?? "",
          "Transporter Bill Date": item.date ?? "",
          ...
          "No of Articles": item.no_of_articles ?? "",
          "Quantity": item.quantity ?? "",
          "Consignor Part No": item.cnpartno ?? "",
          "Consignor Description": item.description ?? "",
          "Consignee": item.consignee ?? "",
          "To": item.to_loc ?? "",
          "Consignee Part No": item.partno ?? "",
          "Trans Mode": item.transport_mode ?? "",
          "Vehicle No": item.vehicle_number ?? "",
          "Driver Name": item.driver_name ?? "",
          "Mobile No": item.mobile_no ?? "",
          "Licence No": item.license_name ?? "",
          "Delivery Type": item.delivery_type ?? "",
          "Total Pkgs": item.total_packages ?? "",
          "Total Weight": item.total_weight ?? "",
          "Total Freight": item.total_freight ?? "",
          "Advance Amount": item.advance_amount ?? "",
          "Balance Amount": item.balance_amount ?? "",
          "Vehicle Pass": item.vehicle_pass ?? "",
          "Parking Charges": item.parking_charges ?? "",
          "Diesel": item.diesel ?? "",
          "Other Charges": item.other_charges ?? "",
          "Delivery Charges": item.delivery_charges ?? "",
          "Mathadi": item.mathadi ?? "",
          "Seal": item.seal ?? "",
          "Adv Ref Name": item.advance_ref ?? "",
          "Remark": item.remarks ?? "",
        };
      });
      ...
      const fileName = `Unloding_Report_export_${formattedDate}_${formattedTime}.xlsx`;
